    ...
    if (productsToShow.length === 0) {
        catalog.innerHTML = `
            <div class="empty-state">
                ...
                <p>Qidiruv so'zingizga mos mahsulot topilmadi. Boshqa so'z bilan qidirib ko'ring.</p>
    ...
    productsToShow.forEach(product => {
        ...
        productCard.innerHTML = `
            ...
            <div class="product-price">
                <span class="current-price">${discountPrice.toLocaleString()} so'm</span>
                ${product.discount > 0 ? `<span class="original-price">${product.price.toLocaleString()} so'm</span>` : ''}
    ...
    if (cart.length === 0) {
        cartContainer.innerHTML = `
            <div class="empty-state">
                ...
                <p>Savatchangizda hali mahsulot yo'q. Mahsulotlarni ko'rib, savatchaga qo'shing.</p>
                <button class="empty-state-btn" onclick="showCatalog()">
        ...
        cartHTML += `
            <div class="cart-item">
                ...
                <div class="cart-item-info">
                    ...
                    <div class="cart-item-price">${discountPrice.toLocaleString()} so'm</div>
